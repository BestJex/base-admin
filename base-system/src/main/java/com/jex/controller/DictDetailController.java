...
import com.jex.service.DictDetailService;
...
public class DictDetailController {
    ...
    public ResponseEntity<Object> create(@Validated  DictDetail resources){
    ...
    public ResponseEntity<Object> update(@Validated(DictDetail.Update.class)  DictDetail resources){
